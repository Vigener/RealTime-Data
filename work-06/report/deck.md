---
presentationID: 1LCTJuu6RhYS5sOw4HS-Qd-dN3C7EGxylWKcCtdpsPyQ
---
...
![fit bg right:40%](images/image-11.png)
...
[ポートフォリオ + 統計] | [取引履歴 + 統計]
``` -->
![drop-shadow:0,5px,10px,rgba(0,0,0,.4)](images/image-7.png)
...
![fit drop-shadow:0,5px,10px,rgba(0,0,0,.4)](images/image-3.png)
